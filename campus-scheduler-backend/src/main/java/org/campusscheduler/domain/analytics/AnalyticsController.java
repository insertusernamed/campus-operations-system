...
public class AnalyticsController {
    ...
    public ResponseEntity<List<RoomUtilizationDTO>> getAllRoomsUtilization(
            @Parameter(description = "Semester to filter by") @RequestParam String semester) {
    ...
    public ResponseEntity<List<RoomUtilizationDTO>> getUnderusedRooms(
            @Parameter(description = "Semester to filter by") @RequestParam String semester,
            @Parameter(description = "Utilization threshold percentage (default: 30)") @RequestParam(defaultValue = "30.0") double threshold) {
