			...
			<div v-else>
				...
				<div class="space-y-4">
					<div>
						...
						<select v-model.number="form.scheduleId" aria-label="Schedule"
					...
					<div>
						...
						<select v-model="form.issue" aria-label="Issue"
							class="w-full px-3 py-2 border border-gray-300 rounded">
					...
					<div class="border border-gray-200 rounded p-4 space-y-3">
							...
							<div class="mt-2 space-y-2 text-sm text-gray-700">
								<label class="flex items-start gap-2">
									...
									<span>
										...
										<span class="block text-xs text-gray-500">Best chance of a workable
											option.</span>
									</span>
								</label>
								<label class="flex items-start gap-2">
						...
						<div v-if="selectedSuggestion" class="pt-2">
							...
							<ScheduleCalendar :schedules="previewSchedules" :height="520"
								:ghost-schedules="previewGhostSchedules" :moved-schedule-ids="previewMovedIds"
					...
					<div>
						...
						<select v-model="form.proposedRoomId" aria-label="Proposed Room"
							class="w-full px-3 py-2 border border-gray-300 rounded">
					...
					<div>
						...
						<select v-model="form.proposedTimeSlotId" aria-label="Proposed Time Slot"
							class="w-full px-3 py-2 border border-gray-300 rounded">
							<option :value="null">Keep current</option>
					...
					<div>
						<label class="block text-sm font-medium text-gray-700 mb-1">Additional details
							(optional)</label>
					...
					<div v-if="validation.hardConflicts.length"
					...
					<div v-if="validation.softWarnings.length"
						class="bg-yellow-50 border border-yellow-200 text-yellow-700 p-3 rounded">
